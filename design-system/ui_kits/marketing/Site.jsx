...
const LOVE = [
  ['Sean Rose', '@seanrose', "Really, really liking Reflect so far. It's just the right amount of simple/fast for a personal note taking app."],
  ['Ryan Delk', '@delk', "Don't take it from me: Reflect is magic."],
  ['Fabrizio Rinaldi', '@linuz90', "I'm keeping Reflect open all the time — for journaling and long-form writing. Rare to see one app work so well for both."],
    ...
    <header style={{ position: 'sticky', top: 0, zIndex: 20, backdropFilter: 'blur(16px)', background: 'rgba(3,0,20,.4)' }}>
      <div style={{ maxWidth: 'var(--site-container)', margin: '0 auto', padding: '20px 28px',
        ...
        <a style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <img src="../../assets/reflect-app-icon.png" width="34" height="34" alt="Reflect" />
          <span style={{ fontSize: 16, fontWeight: 500, color: '#fff' }}>Reflect</span>
        </a>
  ...
  return (
    <section style={{ position: 'relative', textAlign: 'center', padding: '70px 24px 30px' }}>
      ...
      <div style={{ position: 'relative', marginTop: 50 }}>
        <img src="../../assets/reflect-graph-hero.png" alt="A graph of connected notes" style={{ maxWidth: 720, width: '90%', height: 'auto' }} />
      </div>
    </section>
  )
}
...
function AIBanner() {
  return (
    <section style={{ textAlign: 'center', padding: '70px 24px' }}>
      <p style={{ margin: '0 0 14px', fontSize: 13, fontWeight: 500, letterSpacing: '.04em', color: 'var(--purple-light)' }}>Reflect AI</p>
...
function Site() {
  return (
    <div className="reflect-space" style={{ position: 'relative', minHeight: '100%', background: 'var(--space-black)', overflowX: 'hidden' }}>
